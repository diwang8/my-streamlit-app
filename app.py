...
holiday_list = [
    ...
    "2026-09-29", "2026-09-30", "2026-10-01",  # 中秋节
    ...
    # ✅ 2027年节假日（示例：根据常规节日安排）
    "2027-01-01", "2027-01-02", "2027-01-03",  # 元旦
    "2027-02-05", "2027-02-06", "2027-02-07", "2027-02-08", "2027-02-09", "2027-02-10", "2027-02-11", "2027-02-12", "2027-02-13",  # 春节
    "2027-04-03", "2027-04-04", "2027-04-05",  # 清明节
    "2027-05-01", "2027-05-02", "2027-05-03",  # 劳动节
    "2027-06-10", "2027-06-11", "2027-06-12",  # 端午节
    "2027-09-15", "2027-09-16", "2027-09-17",  # 中秋节
    "2027-10-01", "2027-10-02", "2027-10-03", "2027-10-04", "2027-10-05", "2027-10-06", "2027-10-07",  # 国庆节

    # ✅ 2028年节假日（截至12月3日）
    "2028-01-01",  # 元旦
    "2028-01-26", "2028-01-27", "2028-01-28", "2028-01-29", "2028-01-30", "2028-01-31", "2028-02-01", "2028-02-02", "2028-02-03",  # 春节
    "2028-04-03", "2028-04-04", "2028-04-05",  # 清明节
    "2028-05-01", "2028-05-02", "2028-05-03",  # 劳动节
    "2028-06-01", "2028-06-02", "2028-06-03",  # 端午节
    "2028-09-02", "2028-09-03", "2028-09-04",  # 中秋节
    "2028-10-01", "2028-10-02", "2028-10-03", "2028-10-04", "2028-10-05", "2028-10-06", "2028-10-07",  # 国庆节
]
...
if uploaded_file:
    ...
    def suggest_model_type(input_dict, tag_values, marketing_level, competition_level):
        ...
        if marketing_level >= 20 or max_price >= 600:
            ...
            reasons.append("周期较长或常驻/大剧场，适合基本参数侧重模型")
            return "基本参数侧重模型", reasons
        else:
    ...
    with st.expander("🆕 输入新剧信息进行预测", expanded=True):
        ...
        model_types = ["通用模型", "运营侧重模型", "内容侧重模型", "竞争侧重模型", "基本参数侧重模型"]
